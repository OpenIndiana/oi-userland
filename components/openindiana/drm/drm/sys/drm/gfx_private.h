...
// local case for equal testing condiftions on Illumos and Sol11.0 versus modern console 11.1/11.2/11.3/12.x
gfxp_kva_t drmgfxp_map_kernel_space(uint64_t start, size_t size,
        uint32_t mode);
gfxp_kva_t drmgfxp_alloc_kernel_space(size_t size);
void drmgfxp_load_kernel_space(uint64_t start, size_t size,
        uint32_t mode, gfxp_kva_t kvaddr);
void drmgfxp_unmap_kernel_space(gfxp_kva_t address, size_t size);
void drmgfxp_unload_kernel_space(gfxp_kva_t address, size_t size);
void drmgfxp_free_kernel_space(gfxp_kva_t address, size_t size);
//#else
extern gfxp_kva_t gfxp_map_kernel_space(uint64_t start, size_t size,
        uint32_t mode);
extern gfxp_kva_t gfxp_alloc_kernel_space(size_t size);
extern void gfxp_load_kernel_space(uint64_t start, size_t size,
        uint32_t mode, gfxp_kva_t kvaddr);
extern void gfxp_unmap_kernel_space(gfxp_kva_t address, size_t size);
extern void gfxp_unload_kernel_space(gfxp_kva_t address, size_t size);
extern void gfxp_free_kernel_space(gfxp_kva_t address, size_t size);
//#endif
