...
This patch modified at 1.26.0:
- one header file had slight formatting changes, that part of the patch is
  now split into 02-time-slider-part2.patch
- the signature for caja_window_reload changed to accept a 2nd argument,
  gboolean new_tab, so every place caja_window_reload was being called
  there's now a 2nd argument of FALSE

diff -ru --new-file caja-1.24.0/configure.ac caja-1.24.0-patched/configure.ac
--- caja-1.24.0/configure.ac	2020-02-10 11:52:31.000000000 +0000
+++ caja-1.24.0-patched/configure.ac	2020-08-03 19:20:59.502963045 +0000
@@ -144,6 +144,51 @@
...
diff -ru --new-file caja-1.24.0/icons/Makefile.am caja-1.24.0-patched/icons/Makefile.am
--- caja-1.24.0/icons/Makefile.am	2020-02-10 11:52:31.000000000 +0000
+++ caja-1.24.0-patched/icons/Makefile.am	2020-08-03 19:20:59.513897355 +0000
@@ -11,6 +11,17 @@
 	erase.png \
 	knob.png \
 	thumbnail_frame.png \
...
diff -ru --new-file caja-1.24.0/libcaja-private/caja-column-utilities.c caja-1.24.0-patched/libcaja-private/caja-column-utilities.c
--- caja-1.24.0/libcaja-private/caja-column-utilities.c	2020-02-10 11:52:31.000000000 +0000
+++ caja-1.24.0-patched/libcaja-private/caja-column-utilities.c	2020-08-03 19:20:59.524325369 +0000
@@ -174,6 +174,14 @@
...
diff -ru --new-file caja-1.24.0/libcaja-private/caja-directory-async.c caja-1.24.0-patched/libcaja-private/caja-directory-async.c
--- caja-1.24.0/libcaja-private/caja-directory-async.c	2020-02-10 11:52:31.000000000 +0000
+++ caja-1.24.0-patched/libcaja-private/caja-directory-async.c	2020-08-03 19:20:59.540399123 +0000
@@ -777,6 +777,11 @@
...
diff -ru --new-file caja-1.24.0/libcaja-private/caja-directory-private.h caja-1.24.0-patched/libcaja-private/caja-directory-private.h
--- caja-1.24.0/libcaja-private/caja-directory-private.h	2020-02-10 11:52:31.000000000 +0000
+++ caja-1.24.0-patched/libcaja-private/caja-directory-private.h	2020-08-03 19:20:59.552149999 +0000
@@ -61,6 +61,7 @@
     REQUEST_THUMBNAIL,
     REQUEST_MOUNT,
...
diff -ru --new-file caja-1.24.0/libcaja-private/caja-directory.c caja-1.24.0-patched/libcaja-private/caja-directory.c
--- caja-1.24.0/libcaja-private/caja-directory.c	2020-02-10 11:52:31.000000000 +0000
+++ caja-1.24.0-patched/libcaja-private/caja-directory.c	2020-08-03 19:20:59.567477462 +0000
@@ -40,6 +40,7 @@
...
+
 ...
 {
diff -ru --new-file caja-1.24.0/libcaja-private/caja-directory.h caja-1.24.0-patched/libcaja-private/caja-directory.h
--- caja-1.24.0/libcaja-private/caja-directory.h	2020-02-10 11:52:31.000000000 +0000
+++ caja-1.24.0-patched/libcaja-private/caja-directory.h	2020-08-03 19:20:59.580274325 +0000
@@ -29,6 +29,7 @@
 #include <gio/gio.h>
...
diff -ru --new-file caja-1.24.0/libcaja-private/caja-file-attributes.h caja-1.24.0-patched/libcaja-private/caja-file-attributes.h
--- caja-1.24.0/libcaja-private/caja-file-attributes.h	2020-02-10 11:52:31.000000000 +0000
+++ caja-1.24.0-patched/libcaja-private/caja-file-attributes.h	2020-08-03 19:20:59.591754445 +0000
@@ -42,6 +42,7 @@
...
diff -ru --new-file caja-1.24.0/libcaja-private/caja-file-private.h caja-1.24.0-patched/libcaja-private/caja-file-private.h
--- caja-1.24.0/libcaja-private/caja-file-private.h	2020-02-10 11:52:31.000000000 +0000
+++ caja-1.24.0-patched/libcaja-private/caja-file-private.h	2020-08-03 19:20:59.603942549 +0000
@@ -153,6 +153,13 @@
...
diff -ru --new-file caja-1.24.0/libcaja-private/caja-file.c caja-1.24.0-patched/libcaja-private/caja-file.c
--- caja-1.24.0/libcaja-private/caja-file.c	2020-02-10 11:52:31.000000000 +0000
+++ caja-1.24.0-patched/libcaja-private/caja-file.c	2020-08-03 19:25:42.898164827 +0000
@@ -71,6 +71,7 @@
...
diff -ru --new-file caja-1.24.0/libcaja-private/caja-file.h caja-1.24.0-patched/libcaja-private/caja-file.h
--- caja-1.24.0/libcaja-private/caja-file.h	2020-02-10 11:52:31.000000000 +0000
+++ caja-1.24.0-patched/libcaja-private/caja-file.h	2020-08-03 19:20:59.642543003 +0000
@@ -194,6 +194,7 @@
...
diff -ru --new-file caja-1.24.0/libcaja-private/caja-global-preferences.h caja-1.24.0-patched/libcaja-private/caja-global-preferences.h
--- caja-1.24.0/libcaja-private/caja-global-preferences.h	2020-02-10 11:52:31.000000000 +0000
+++ caja-1.24.0-patched/libcaja-private/caja-global-preferences.h	2020-08-03 19:20:59.656577165 +0000
@@ -70,6 +70,9 @@
...
diff -ru --new-file caja-1.24.0/libcaja-private/caja-zfs.c caja-1.24.0-patched/libcaja-private/caja-zfs.c
--- caja-1.24.0/libcaja-private/caja-zfs.c	1970-01-01 01:00:00.000000000 +0000
+++ caja-1.24.0-patched/libcaja-private/caja-zfs.c	2020-08-03 19:20:59.669469955 +0000
@@ -0,0 +1,1239 @@
+/* 
...
+}
+
diff -ru --new-file caja-1.24.0/libcaja-private/caja-zfs.h caja-1.24.0-patched/libcaja-private/caja-zfs.h
--- caja-1.24.0/libcaja-private/caja-zfs.h	1970-01-01 01:00:00.000000000 +0000
+++ caja-1.24.0-patched/libcaja-private/caja-zfs.h	2020-08-03 19:20:59.682761170 +0000
@@ -0,0 +1,75 @@
+#ifndef CAJA_ZFS_H
+#define CAJA_ZFS_H
+
...
+                           gpointer            data);
+#endif /* CAJA_ZFS_H */
diff -ru --new-file caja-1.24.0/libcaja-private/Makefile.am caja-1.24.0-patched/libcaja-private/Makefile.am
--- caja-1.24.0/libcaja-private/Makefile.am	2020-02-10 11:52:31.000000000 +0000
+++ caja-1.24.0-patched/libcaja-private/Makefile.am	2020-08-03 19:20:59.697152829 +0000
@@ -37,7 +37,10 @@
...
diff -ru --new-file caja-1.24.0/libcaja-private/org.mate.caja.gschema.xml caja-1.24.0-patched/libcaja-private/org.mate.caja.gschema.xml
--- caja-1.24.0/libcaja-private/org.mate.caja.gschema.xml	2020-02-10 11:52:31.000000000 +0000
+++ caja-1.24.0-patched/libcaja-private/org.mate.caja.gschema.xml	2020-08-03 19:20:59.712093632 +0000
@@ -81,6 +81,11 @@
...
diff -ru --new-file caja-1.24.0/src/caja-actions.h caja-1.24.0-patched/src/caja-actions.h
--- caja-1.24.0/src/caja-actions.h	2020-02-10 11:52:32.000000000 +0000
+++ caja-1.24.0-patched/src/caja-actions.h	2020-08-03 19:20:59.726283287 +0000
@@ -28,6 +28,7 @@
...
diff -ru --new-file caja-1.24.0/src/caja-file-management-properties.c caja-1.24.0-patched/src/caja-file-management-properties.c
--- caja-1.24.0/src/caja-file-management-properties.c	2020-02-10 11:52:32.000000000 +0000
+++ caja-1.24.0-patched/src/caja-file-management-properties.c	2020-08-03 19:20:59.741277467 +0000
@@ -72,6 +72,7 @@
...
diff -ru --new-file caja-1.24.0/src/caja-navigation-window-ui.xml caja-1.24.0-patched/src/caja-navigation-window-ui.xml
--- caja-1.24.0/src/caja-navigation-window-ui.xml	2020-02-10 11:52:32.000000000 +0000
+++ caja-1.24.0-patched/src/caja-navigation-window-ui.xml	2020-08-03 19:20:59.753546316 +0000
@@ -63,6 +63,7 @@
...
diff -ru --new-file caja-1.24.0/src/caja-navigation-window.c caja-1.24.0-patched/src/caja-navigation-window.c
--- caja-1.24.0/src/caja-navigation-window.c	2020-02-10 11:52:32.000000000 +0000
+++ caja-1.24.0-patched/src/caja-navigation-window.c	2020-08-03 19:20:59.768327889 +0000
@@ -71,6 +71,7 @@
...
+
 ...
 {
diff -ru --new-file caja-1.24.0/src/caja-navigation-window.h caja-1.24.0-patched/src/caja-navigation-window.h
--- caja-1.24.0/src/caja-navigation-window.h	2020-02-10 11:52:32.000000000 +0000
+++ caja-1.24.0-patched/src/caja-navigation-window.h	2020-08-03 19:20:59.781014876 +0000
@@ -68,10 +68,17 @@
     /** UI stuff **/
...
diff -ru --new-file caja-1.24.0/src/caja-shell-ui.xml caja-1.24.0-patched/src/caja-shell-ui.xml
--- caja-1.24.0/src/caja-shell-ui.xml	2020-02-10 11:52:32.000000000 +0000
+++ caja-1.24.0-patched/src/caja-shell-ui.xml	2020-08-03 19:20:59.792985286 +0000
@@ -45,6 +45,7 @@
 	<menu action="View">
...
+		<menuitem name="Restore" action="Restore"/>
 		...
 		<separator/>
diff -ru --new-file caja-1.24.0/src/caja-window-manage-views.c caja-1.24.0-patched/src/caja-window-manage-views.c
--- caja-1.24.0/src/caja-window-manage-views.c	2020-02-10 11:52:32.000000000 +0000
+++ caja-1.24.0-patched/src/caja-window-manage-views.c	2020-08-03 19:20:59.808220780 +0000
@@ -30,6 +30,7 @@
 #include <gtk/gtk.h>
 #include <gdk/gdkx.h>
 #include <glib/gi18n.h>
...
diff -ru --new-file caja-1.24.0/src/caja-window-menus.c caja-1.24.0-patched/src/caja-window-menus.c
--- caja-1.24.0/src/caja-window-menus.c	2020-02-10 11:52:32.000000000 +0000
+++ caja-1.24.0-patched/src/caja-window-menus.c	2020-08-03 19:20:59.822845377 +0000
@@ -57,6 +57,8 @@
...
diff -ru --new-file caja-1.24.0/src/caja-window-slot.c caja-1.24.0-patched/src/caja-window-slot.c
--- caja-1.24.0/src/caja-window-slot.c	2020-02-10 11:52:32.000000000 +0000
+++ caja-1.24.0-patched/src/caja-window-slot.c	2020-08-03 19:20:59.835309500 +0000
@@ -683,6 +683,13 @@
...
+
     ...
     g_free (slot->title);
diff -ru --new-file caja-1.24.0/src/caja-window-slot.h caja-1.24.0-patched/src/caja-window-slot.h
--- caja-1.24.0/src/caja-window-slot.h	2020-02-10 11:52:32.000000000 +0000
+++ caja-1.24.0-patched/src/caja-window-slot.h	2020-08-03 19:20:59.847207031 +0000
@@ -113,6 +113,7 @@
...
diff -ru --new-file caja-1.24.0/src/caja-window.c caja-1.24.0-patched/src/caja-window.c
--- caja-1.24.0/src/caja-window.c	2020-02-10 11:52:32.000000000 +0000
+++ caja-1.24.0-patched/src/caja-window.c	2020-08-03 19:20:59.863665693 +0000
@@ -418,6 +418,18 @@
...
diff -ru --new-file caja-1.24.0/src/caja-zfs-bar.c caja-1.24.0-patched/src/caja-zfs-bar.c
--- caja-1.24.0/src/caja-zfs-bar.c	1970-01-01 01:00:00.000000000 +0000
+++ caja-1.24.0-patched/src/caja-zfs-bar.c	2020-08-03 19:20:59.888691553 +0000
@@ -0,0 +1,851 @@
+/* 
...
+}
+
diff -ru --new-file caja-1.24.0/src/caja-zfs-bar.h caja-1.24.0-patched/src/caja-zfs-bar.h
--- caja-1.24.0/src/caja-zfs-bar.h	1970-01-01 01:00:00.000000000 +0000
+++ caja-1.24.0-patched/src/caja-zfs-bar.h	2020-08-03 19:20:59.900040564 +0000
@@ -0,0 +1,56 @@
...
diff -ru --new-file caja-1.24.0/src/file-manager/caja-directory-view-ui.xml caja-1.24.0-patched/src/file-manager/caja-directory-view-ui.xml
--- caja-1.24.0/src/file-manager/caja-directory-view-ui.xml	2020-02-10 11:52:32.000000000 +0000
+++ caja-1.24.0-patched/src/file-manager/caja-directory-view-ui.xml	2020-08-03 19:20:59.914144901 +0000
@@ -71,6 +71,9 @@
...
diff -ru --new-file caja-1.24.0/src/file-manager/fm-actions.h caja-1.24.0-patched/src/file-manager/fm-actions.h
--- caja-1.24.0/src/file-manager/fm-actions.h	2020-02-10 11:52:32.000000000 +0000
+++ caja-1.24.0-patched/src/file-manager/fm-actions.h	2020-08-03 19:20:59.925362287 +0000
@@ -58,6 +58,9 @@
...
diff -ru --new-file caja-1.24.0/src/file-manager/fm-directory-view.c caja-1.24.0-patched/src/file-manager/fm-directory-view.c
--- caja-1.24.0/src/file-manager/fm-directory-view.c	2020-02-10 11:52:32.000000000 +0000
+++ caja-1.24.0-patched/src/file-manager/fm-directory-view.c	2020-08-03 19:20:59.945788760 +0000
@@ -1009,6 +1009,77 @@
 	return FALSE;
 }
...
diff -ru --new-file caja-1.24.0/src/file-manager/fm-marshal.list caja-1.24.0-patched/src/file-manager/fm-marshal.list
--- caja-1.24.0/src/file-manager/fm-marshal.list	2020-02-10 11:59:40.000000000 +0000
+++ caja-1.24.0-patched/src/file-manager/fm-marshal.list	1970-01-01 01:00:00.000000000 +0000
@@ -1,2 +0,0 @@
-BOOLEAN:VOID
-VOID:OBJECT,OBJECT
diff -ru --new-file caja-1.24.0/src/Makefile.am caja-1.24.0-patched/src/Makefile.am
--- caja-1.24.0/src/Makefile.am	2020-02-10 11:52:32.000000000 +0000
+++ caja-1.24.0-patched/src/Makefile.am	2020-08-03 19:20:59.962660492 +0000
@@ -35,6 +35,8 @@
 	$(EXIF_LIBS) \
 	$(EXEMPI_LIBS) \
 	$(POPT_LIBS) \
...
+	timescale.c \
 ...
 nodist_caja_SOURCES = \
diff -ru --new-file caja-1.24.0/src/timescale.c caja-1.24.0-patched/src/timescale.c
--- caja-1.24.0/src/timescale.c	1970-01-01 01:00:00.000000000 +0000
+++ caja-1.24.0-patched/src/timescale.c	2020-08-03 19:20:59.975269341 +0000
@@ -0,0 +1,1286 @@
+/* 
...
+}
+
diff -ru --new-file caja-1.24.0/src/timescale.h caja-1.24.0-patched/src/timescale.h
--- caja-1.24.0/src/timescale.h	1970-01-01 01:00:00.000000000 +0000
+++ caja-1.24.0-patched/src/timescale.h	2020-08-03 19:20:59.987816285 +0000
@@ -0,0 +1,58 @@
