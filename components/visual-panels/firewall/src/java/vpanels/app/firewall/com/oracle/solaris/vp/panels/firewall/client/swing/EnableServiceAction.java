...
public class EnableServiceAction
    extends EnableManagedObjectAction<ServiceManagedObject, Object, Object> {
    ...
    @Override
    public Object workBusy(List<ServiceManagedObject> selection, Object input)
	throws ActionAbortedException, ActionFailedException,
	ActionUnauthorizedException {

	boolean enable = getEnable();

	for (ServiceManagedObject service : selection) {
//	    try {
