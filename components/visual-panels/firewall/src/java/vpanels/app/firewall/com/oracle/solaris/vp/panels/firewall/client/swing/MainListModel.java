...
public class MainListModel implements ListModel {
    ...
    private ManagedObjectTableModel<ServiceManagedObject> model;
    ...
    public MainListModel(FirewallPanelDescriptor descriptor) {
	model = new ManagedObjectTableModel<ServiceManagedObject>(descriptor);
    }
