...
public class AddManagedObjectAction<S extends ManagedObject, I, O>
    ...
    public AddManagedObjectAction(String text, Collection<? extends Icon> icons,
	ClientContext context, HasComponent hasComponent) {
