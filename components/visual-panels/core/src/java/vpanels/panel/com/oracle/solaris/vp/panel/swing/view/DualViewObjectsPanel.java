...
/**
 * The {@code DualViewObjectsPanel} class adds a table view to the {@code
 * ListObjectsPanel}.
 */
@SuppressWarnings({"serial"})
public class DualViewObjectsPanel<C extends ManagedObject>
    extends ListObjectsPanel<C> {
    ...
    public DualViewObjectsPanel(ManagedObject<C> pObject,
	StructuredAction<List<C>, ?, ?>[] mActions,
	StructuredAction<List<C>, ?, ?> dmAction, String title, String help,
	PropInfo<C, ?>[] props) {

	super(pObject, mActions, dmAction, title, help, true);
