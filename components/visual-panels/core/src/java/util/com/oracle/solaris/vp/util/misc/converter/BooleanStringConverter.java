...
public class BooleanStringConverter extends StringConverter<Boolean> {
    ...
    public static final BooleanStringConverter INSTANCE =
    ...
    /**
     * Converts the given {@code String} to a {@code Boolean}.
     *
     * @param	    s
     *		    the {@code String} to convert
     *
     * @return	    {@code null} if {@code s} is {@code null}, a {@code Boolean}
     *		    otherwise
     */
    @Override
