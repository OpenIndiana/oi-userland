...
public interface SwingPropInfo<M, T> extends PropInfo<M, T> {
    //
    // SwingPropInfo methods
    //

    /**
     * Returns a custom editor for this property, or {@code null} to use the
     * default editor.
     */
    TableCellEditor getTableCellEditor();

    /**
     * Returns a custom renderer for this property, or {@code null} to use the
     * default renderer.
     */
