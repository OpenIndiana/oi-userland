...
PKG_OPTIONS +=		$(PKG_MACROS:%=-D %) -D COMPONENT_SUMMARY="$(strip $(COMPONENT_SUMMARY))" -D COMPONENT_CLASSIFICATION="org.opensolaris.category.2008:$(strip $(COMPONENT_CLASSIFICATION))" -D COMPONENT_LICENSE="$(strip $(COMPONENT_LICENSE))"
