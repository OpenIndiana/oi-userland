...
# Component defaults
COMPONENT_VERSION ?=		$(shell $(WS_TOOLS)/perl-version-convert $(COMPONENT_NAME) $(patsubst v%,%,$(HUMAN_VERSION)))
...
COMPONENT_PROJECT_URL ?=	https://metacpan.org/dist/$(COMPONENT_NAME)
